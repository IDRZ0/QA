...
public class SumaTestParameters {
    private int firstNumber;
    private int secondNumber;
    private int expectedResult;

    public SumaTestParameters(int firstNumber, int secondNumber, int expectedResult) {
    ...
    public void verify_suma_all_values() {
        ...
        int actualResult = calculadora.suma(this.firstNumber, this.secondNumber);
        Assert.assertEquals("Falla loco", this.expectedResult, actualResult);
    }
}
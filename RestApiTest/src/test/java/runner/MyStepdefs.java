...
public class MyStepdefs {
    ...
    @When("yo envio una peticion POST a la url {} con json")
    public void yoEnvioUnaPeticionPOSTALaUrlHttpTodoLyApiProjectsJsonConJson(String url, String body) {
        response = given().
                auth().
                preemptive().
    ...
    public void yoEsperoQueElNombreDelProjectSea(String type, String expectedName) {
        response.then().
    ...
    public void yoEsperoElResponseBodySea(String expectedBody) {
        Assert.assertTrue("Los json no son iguales", JsonCompare.areEqualJson(replaceAllData(expectedBody), response.getBody().asString()));
    }
